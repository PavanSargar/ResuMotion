...
export const MinimalistATS: React.FC<Props> = ({ data }) => {
  return (
    <div className="w-full h-full bg-white text-black p-10 min-h-[1056px] font-serif">
      ...
      <div className="text-center border-b-2 border-black pb-6 mb-6">
        ...
        <p className="text-sm mb-2">{data.personalInfo.location} | {data.personalInfo.phone} | {data.personalInfo.email}</p>
        <div className="text-sm">
          <a href={`https://${data.personalInfo.linkedin}`} className="underline mr-3 text-blue-800">{data.personalInfo.linkedin}</a>
          <a href={`https://${data.personalInfo.github}`} className="underline mr-3 text-blue-800">{data.personalInfo.github}</a>
        </div>
      </div>

      {/* Summary */}
      <div className="mb-6">
        <h2 className="font-bold text-lg uppercase border-b border-gray-300 mb-3 pb-1">Professional Summary</h2>
        <p className="text-sm leading-relaxed text-justify">{data.personalInfo.summary}</p>
      </div>

      {/* Skills */}
      <div className="mb-6">
        <h2 className="font-bold text-lg uppercase border-b border-gray-300 mb-3 pb-1">Technical Skills</h2>
      ...
      {/* Experience */}
      <div className="mb-6">
        <h2 className="font-bold text-lg uppercase border-b border-gray-300 mb-4 pb-1">Work Experience</h2>
